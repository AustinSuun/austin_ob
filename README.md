...
欢迎来到我的个人数字花园！这是一个致力于记录算法设计、服务器架构以及 AI 研究的心灵空间。
...
本项目基于 [Quartz v4](https://quartz.jzhao.xyz/) 驱动，GitHub 仓库地址为 [jackyzha0/quartz](https://github.com/jackyzha0/quartz)。
